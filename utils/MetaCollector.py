...
class MetaCollector:
    ...
    def date_to_JSON(self):
        ...
        publish_Date = find_date(self.response.content, extensive_search=True, original_date= True)
        update_Date = find_date(self.response.content, extensive_search= False, original_date= False)
